...
<span class="sources">Kim et al., *[Towards a Science of Scaling Agent Systems](https://arxiv.org/abs/2512.08296)*, arXiv 2512.08296, Dec 2025. 260 configurations, 6 benchmarks, 5 architectures. Numbers as reported in the abstract and paper summaries.</span>
...
<span class="sources">[anthropic.com/research/multiagent-systems](https://www.anthropic.com/research/multiagent-systems). Findings as reported; primary text was not reachable from the build environment.</span>
